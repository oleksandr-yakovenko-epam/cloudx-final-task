...
namespace Microsoft.eShopWeb.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton(c => new TestSettings
            {
                InstanceName = Configuration["INSTANCE_NUM"]
            });

            services.AddSingleton(c => new CosmosDbSettings
            {
                Endpoint = Configuration["COSMOS_DB_ENDPOINT"],
                Key = Configuration["COSMOS_DB_KEY"],
            });

            services.AddScoped(c => new ServiceBusSettings
            {
                ConnectionString = Configuration["SERVICE_BUS_CONNECTION_STRING"]
            });
